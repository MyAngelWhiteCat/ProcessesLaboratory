...
- RWX сканнер - поиск регионов памяти процессов c правами RWX, а так же регионов, чьи права были изменены с RX на RW и RW На RX (RX->RW->RX последовательность для инжекта произвольного кода)
- Сканнер всех включенных привилегий - индекс PID, имя процесса - все включенные привелегии. 
- Сканнер процессов запущенных от имени администратора или имеющих группу администраторов 
